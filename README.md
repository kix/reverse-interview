...
- Как вы принимаете глобальные архитектурные или технические решения? Записываете ли вы эти решения? (см. [ADR](https://adr.github.io/))
- Какие метрики сложности и объёма кода вы собираете?
- Следите ли вы за "горячими" местами в коде - теми, которые модифицируются чаще всего?
...
- Собираете ли вы [индивидуальные планы развития](https://github.com/luistak/idp-guideline) для ваших разработчиков?
