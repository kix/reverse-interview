...
Само по себе наличие баг-трекера не делает работу над багами эффективной, а наличие CI/CD не означает, что время выполнения и выкатывания фич сокращается.
...
- Ставите ли вы тайм-трекеры или снимальщики экранов?
...
## Тревожные звоночки
При возникновении подобных моментов на собеседовании стоит лишний раз подумать о трудоустройстве в компанию.

- **Мы одна семья** - в данном случае речь не идёт о заботе о тебе как о работнике или специалисте. Скорее это означает, что работать придётся как в большой семье, при этом большую оплату гарантировать никто не может.
- **Неуважение на собеседовании**
- **Неоплачиваемые тестовые задания большого объёма**
- **Работа на выходных** - при этом про оплату речи не идёт. Просто говорится подобная фраза и ждут на неё реакцию.
- **Нарушение личных границ** - вопросы про семью, детей, политические взгляды и прочее.
- **Враньё** - когда, например, говорили про одну зарплатную вилку, а при оформлении совсем другая, меньше.
